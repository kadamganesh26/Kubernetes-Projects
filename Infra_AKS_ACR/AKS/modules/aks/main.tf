resource "azurerm_kubernetes_cluster" "aks" {
  ...
  dynamic "network_profile" {
    ...
    for_each = each.value.network_profile != null ? [
      each.value.network_profile
    ] : []
  ...
  dynamic "ingress_application_gateway" {
    ...
    for_each = each.value.ingress_application_gateway != null ? [
      each.value.ingress_application_gateway
    ] : []
